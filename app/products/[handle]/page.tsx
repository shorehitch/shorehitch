...
import StandaloneEngravingPurchase from "../../../components/cart/standalone-engraving-purchase";
 ...
 return <SiteShell>
  ...
  <section className="mx-auto grid max-w-7xl gap-10 px-5 py-10 md:px-8 md:py-14 lg:grid-cols-[1.08fr_.92fr] lg:gap-14">
   ...
   <div className="lg:sticky lg:top-32 lg:self-start">
    ...
    <div className="mt-6 rounded-xl border border-white/10 bg-[#070707] p-5 md:p-6">{handle==="custom-engraving"?<StandaloneEngravingPurchase productId={product.id} productName={product.title} variants={product.variants.nodes} logoUploadsEnabled={logoUploadsEnabled}/>:<ProductPurchase productId={product.id} productName={product.title} variants={product.variants.nodes} enableEngraving={ENGRAVABLE_HANDLES.has(handle)} engravingVariantId={engravingVariantId} logoUploadsEnabled={logoUploadsEnabled} softTop={softTop} hardCase={hardCase}/>}</div>
