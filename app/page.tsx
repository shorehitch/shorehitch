      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto grid min-h-[680px] max-w-7xl items-center gap-12 px-5 py-20 md:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:py-28">
          ...
          <div className="relative hidden lg:block">
            ...
            {og?.featuredImage ? (
              <Image src={og.featuredImage.url} alt={og.featuredImage.altText || og.title} width={og.featuredImage.width || 1400} height={og.featuredImage.height || 1400} sizes="45vw" priority className="relative mx-auto aspect-square w-full max-w-xl rounded-3xl object-cover" />
            ) : <div className="relative aspect-square rounded-3xl border border-white/10 bg-[#0A0A0A]" />}
          </div>
        </div>
      </section>
